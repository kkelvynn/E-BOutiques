...
if($fetch_profile->rowCount() > 0){
   $admin_data = $fetch_profile->fetch(PDO::FETCH_ASSOC);
} else {
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      ?>
      <input type="hidden" name="prev_pass" value="<?= $admin_data['password']; ?>">
      <input type="text" name="name" value="<?= $admin_data['name']; ?>" required placeholder="Enter your username" maxlength="20" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
